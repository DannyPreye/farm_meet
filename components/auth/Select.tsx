    ...
    return (
        <div className="w-[90%] mx-auto max-w-[566px] relative">
            <select
                ...
                className={`w-full px-[22px] text-[#B6B1B1] relative font-semibold appearance-none  focus:border-none focus:outline-none py-[12px] mx-auto  h-[55px] rounded-[17px] bg-secondary-white ${
                    error ? "border-2 border-red-500" : "border-none"
                }`}
            >
                <option className="" value={defaultValue} selected disabled>
                    {defaultValue}
                </option>
